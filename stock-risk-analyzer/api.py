...
def analyze_stock(ticker):
    try:
        ...
        # Make prediction
        risk_level_str = model.predict(latest_data.values.reshape(1, -1))[0]
        # Map risk level string to integer
        risk_level_map = {
            'Low': 0,
            'Medium': 1,
            'High': 2
        ...
        # Convert the risk level to an integer
        risk_level = risk_level_map.get(risk_level_str, -1)
